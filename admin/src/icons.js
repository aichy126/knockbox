// lucide 风格线性图标，24 网格 / stroke 1.8 / round cap，与公开页和设计稿同一批。
export const icons = {
...
// 品牌标：一个盒子 + 两道敲击的声波，与服务端 style.go 的 Mark 同形。
export const mark = '<svg viewBox="0 0 64 64" fill="none" width="20" height="20" aria-hidden="true"><rect x="9" y="24" width="36" height="30" rx="7" stroke="currentColor" stroke-width="6"/><path d="M46 14a10 10 0 0 1 8 8" stroke="currentColor" stroke-width="5" stroke-linecap="round"/><path d="M50 5a19 19 0 0 1 12 12" stroke="currentColor" stroke-width="5" stroke-linecap="round"/></svg>'
